...
flash_mamba_rl.bench.c4_complex_scan_rope --out ~/out/c4_bench.json``
...
from flash_mamba_rl.kernels.ops import complex_scan_rope, triton_complex_rope_resource_meta
