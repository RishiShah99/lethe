...
warp-shuffle reverse scan for the backward) — the design the fast official
Mamba-1 backward uses — to close the residual speed gap against the crippled
official Mamba-3 backward, still with zero tensor cores / ``mma`` / ``tl.dot``.
...
Build plan + design rationale: ``docs/cuda_warpscan_plan.md``.
"""
