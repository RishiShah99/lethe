...
def run_k1_incB(
    ...
    if l2_dims_ok(c, d_k, do.shape[-1]):
...
# run_k1_incB_serial stays as the proven per-group fallback; inc-B2 (run_k1_incB2
# above, the fully fused kernel) supersedes the per-step paths once box-green.
