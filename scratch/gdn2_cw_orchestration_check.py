...
def main() -> None:
    ...
    assert all(torch.equal(x, y) for x, y in zip(a, e)), "run_k1_cw_ref != assembly k1 closed form"
    ...
    assert all(torch.equal(x, y) for x, y in zip(a2, e2)), "run_k2_cw_ref != assembly k2 closed form"
